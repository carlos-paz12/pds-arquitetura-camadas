...
public class ViewAtualizarAvaliacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnBackView.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifrn/ifilmes/views/resourcers/icon_back_arrow.png"))); // NOI18N
    ...
    private void buttonAtualizarFilmeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAtualizarFilmeActionPerformed
        ...
        boolean result = atualizarAvaliacaoFilme(id, novaAvaliacao);
    ...
    private boolean atualizarAvaliacaoFilme(int idFilme, double novaAvaliacao) {
