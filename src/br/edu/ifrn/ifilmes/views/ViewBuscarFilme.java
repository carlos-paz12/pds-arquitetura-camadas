package br.edu.ifrn.ifilmes.views;

import br.edu.ifrn.ifilmes.data.FilmeDAO;
import br.edu.ifrn.ifilmes.models.Filme;
...
public class ViewBuscarFilme extends javax.swing.JFrame {
    ...
    public ViewBuscarFilme() {
        ...
        Filme filme = buscarFilmeMaisRecente();
        if (filme != null)
        {
    ...
    private void initComponents() {
        ...
        buttonVoltarView.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifrn/ifilmes/views/resourcers/icon_back_arrow.png"))); // NOI18N
    ...
    private void txtFieldBarraPesquisaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFieldBarraPesquisaKeyPressed
        ...
        {
            Filme filmePesquisa = buscarFilmePesquisado(txtFieldBarraPesquisa.getText());
    ...
    private Filme buscarFilmePesquisado(String titulo) {
        return new FilmeDAO().retrieve(titulo);
    }

    private Filme buscarFilmeMaisRecente() {
        return new FilmeDAO().retrieveLatest();
    }
